...
\address{Website: \href{https://www.uiuc-bdeep.org/christensen}{https://www.uiuc-bdeep.org/christensen}} % Your address
\address{1301 W. Gregory Dr., University of Illinois, Urbana-Champaign} % Your secondary addess (optional)
...
{University of Illinois, Urbana-Champaign}\\
{\bf Visiting Assistant Professor (upcoming spring semester)}  \hfill {2019} \\
{Department of Economics, Duke University} 
\end{rSection}
%----------------------------------------------------------------------------------------
%	OTHER AFFILIATIONS
%----------------------------------------------------------------------------------------
\begin{rSection}{Academic and Other Affiliations}
{\bf Principal Investigator}, Big Data for Environmental Economics and Policy (BDEEP)   \\
{\bf Steering Committee}, Illinois Data Science Initiative (iDSI)   \\
{\bf Faculty Affiliate}, Cline Center for Advanced Social Research   \\
{\bf Faculty Affiliate}, National Center for Supercomputing Applications Industry Program   \\
{\bf Academic Partner}: Uber Research, Zillow Research, AirDNA, Google Earth Engine   \\
\end{rSection}
%%-------------------------------------------------------------------------
...
%%%
\publication{albouyunlockingnber}
...
\publication{toxicdiscrimination}
\publication{christensenosman}
\publication{christensencontractor}
\publication{bentofloods}
...
{\bf Total Funding Support \hfill {\bf \$827,668 -- 2015-2018}}\\

{\bf Russell Sage Foundation} \hfill {\bf \$148,088 -- 2018-2020} \\
Welfare Impacts of Housing Discrimination on Location Choice \\
...
Experimental Evidence on the Effect of Mobility-on-Demand Services in \\ Developing Country Cities \\
{\bf Lemann Institute}  \hfill {\bf \$6,780 -- 2017-2018}  \\
